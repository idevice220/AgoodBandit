...
###########"SAMBA"#######################
	...
	if choix_acueil == 3 and duplication_enable ==0:
...
#					print(broadcast)
			...
			choix_acueil == 1 and dupication_enable ==0
...
#		mon_fichier.write("\n")
	...
	if choix_acueil == 3 and duplication_enable == 1:
		...
		if os.path.isfile('serveur_fichier.txt'):
			...
			print('fichier non trouvé')
			choix_acueil == 3 and duplication_enable == 0
